...
interface HorizonApi {
  ...
  fun getWithdrawTask(listener: SuccessErrorCallback, asset: Asset, secretSeed: CharArray, destination: String, memo: String?, amount: String): AsyncTask<Void, Void, HorizonException>
