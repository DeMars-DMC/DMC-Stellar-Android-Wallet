...
class WalletActivity : BaseActivity(), io.demars.stellarwallet.utils.KeyboardUtils.SoftKeyboardToggleListener {
    ...
    override fun onResume() {
        ...
        io.demars.stellarwallet.utils.KeyboardUtils.addKeyboardToggleListener(this, this)
    }

    override fun onPause() {
        super.onPause()
        io.demars.stellarwallet.utils.KeyboardUtils.removeKeyboardToggleListener(this)
    }
